                                ...
                                <form action="{{route('ads.update',$ad->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 ">
                                            ...
                                            @if($ad->photo()->first())
                                                <div class="col-sm-3" id="photo_{{$ad->photo()->first()->id}}"
                                                     style="margin:2%;">
                                                    <img class="img-responsive"
                                                         src="{{asset($ad->photo()->first()->path)}}"
                                                         alt="image">
                                                    <a href="{{route('photoDestroy',$ad->photo()->first()->id)}}"
                                        ...
                                        <div class="col-md-4" style="margin-top: 5%">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control" name="type">
                                                    <option value="1" @if($ad->number == "1" ) selected @endif>1
                                                    </option>
                                                    <option value="2" @if($ad->number == "2" ) selected @endif>2
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
