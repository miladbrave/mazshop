                ...
                <div id="content" class="col-sm-12">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                <td>تصویر</td>
                                <td class="text-center"><img class="img-thumbnail" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" src="{{asset('/front/image/product/macbook_air_1-90x135.jpg')}}"></td>
                                <td class="text-center"><img class="img-thumbnail" title=" کتاب آموزش باغبانی " alt=" کتاب آموزش باغبانی " src="{{asset('/front/image/product/FinePix-Long-Zoom-Camera-200x200.jpg')}}"></td>
                                <td class="text-center"><img class="img-thumbnail" title="تبلت ایسر" alt="تبلت ایسر" src="{{asset('/front/image/product/samsung_tab_1-90x135.jpg')}}"></td>
                            </tr>
                            <tr>
                                <td>قیمت</td>
